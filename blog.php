        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="header-elements header-elements-1">
                          ...
                          <div class="d-flex">
                            ...
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn1 mb-20" href="index.html">Multi Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                                <a class="header-btn1" href="index-single-1.html">One Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                            ...
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn1 mb-20" href="index-2.html">Multi Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                                <a class="header-btn1" href="index-single-2.html">One Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                            ...
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn1 mb-20" href="index-3.html">Multi Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                                <a class="header-btn1" href="index-single-3.html">One Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                            ...
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn1 mb-20" href="index-4.html">Multi Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                                <a class="header-btn1" href="index-single-4.html">One Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                            ...
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn1 mb-20" href="index-5.html">Multi Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                                <a class="header-btn1" href="index-single-5.html">One Page <span><i
                                      class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
              ...
              <div class="btn-area">
                <a href="contact.html" class="header-btn1">Donate <span><i
                      class="fa-solid fa-arrow-right"></i></span></a>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-8">
          <div class="vl-event-content-area mr-50">
            ...
            <div class="vl-blog-meta-box mt-32">
              <ul>
                <li><a href="#"> <span class="icon"><img class="mt-4-" src="assets/img/icons/vl-calender-1.1.svg"
                        alt=""></span> 8/10/2025</a></li>

              </ul>
            </div>
            <div class="vl-event-content vl-blg-content">
              <h2 class="title">Tips for Disaster Preparedness: How <br> to Stay Safe and Ready</h2>
              <p class="para pb-16">Our blog is a space where we share the heart of our mission, offering an inside look
                at the incredible work being done and the lives being transformed through your support. Each post
                features real stories from the field, updates on our current projects. </p>
              <p class="para pb-32">Whether you're learning about a new initiative, discovering how your donations are
                making an impact, or finding inspiration to get involved, our blog is here to connect.</p>
            </div>
            <div class="vl-blg-icon-box">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="single-blog-box1 mb-30">
                    <img class="w-100" src="assets/img/blog/vl-blg-1.1.png" alt="">
                  </div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <div class="single-blog-box1 mb-30">
              ...
              <div class="vl-rec-blog-flex">
                ...
                <div class="vl-rec-blog-content">
                  ...
                  <div class="vl-rec-blog-content-heading">
                    <h3 class="tittle"><a href="blog-single.html">Stories from the Field:<br> Firsthand Accounts
                        ....</a></h3>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
            ...
            <div class="vl-meta">
              <ul>
                <li><a href="#"><span class="top-minus"> <img src="assets/img/icons/vl-calender-1.1.svg" alt=""></span>
                    16 October 2025</a></li>
                <li><a href="#"><span class="top-minus"> <img src="assets/img/icons/vl-user-1.1.svg" alt=""></span>Kyle
                    Miller</a></li>
              </ul>
            </div>
            <div class="vl-blg-content">
              <h3 class="title"><a href="blog-single.html">Stories from the Field: Firsthand <br> Accounts of Disaster
                  Relief</a></h3>
              <p>Get inside look at the real-life experiences of <br> our teams ground from emergency response.</p>
              <a href="blog-single.html" class="read-more">Read More <span><i
                    class="fa-solid fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
          ...
          <div class="vl-single-blg-item mb-30">
            ...
            <div class="vl-meta">
              <ul>
                <li><a href="#"><span class="top-minus"> <img src="assets/img/icons/vl-calender-1.1.svg" alt=""></span>
                    16 October 2025</a></li>
                <li><a href="#"><span class="top-minus"> <img src="assets/img/icons/vl-user-1.1.svg" alt=""></span> Leg
                    Colleen</a></li>
              </ul>
            </div>
            <div class="vl-blg-content">
              <h3 class="title"><a href="blog-single.html">Tips for Disaster Preparedness: How <br> to Stay Safe and
                  Ready</a></h3>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="vl-single-blg-item mb-30">
            ...
            <div class="vl-blg-content">
              <h3 class="title"><a href="blog-single.html">Partnering for Good: The Role of Collaboration in Crisis
                  Relief</a></h3>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="vl-cta-content text-center">
              ...
              <p>Every action, no matter how small, can make a world of difference in <br> the lives of those affected
                by disaster. Whether it’s a donation.</p>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="vl-footer-widget-1 mb-30">
            ...
            <div class="vl-footer-content">
              <p>Now the time act because every second counts, and contribution brings one step closer a brighter future
                Join us today & difference.</p>
            </div>
